<template>
    <div class="animation-speed-slider-wrapper">
        ...
        <input @change="$emit('change', $event)" :value="value" class="animation-speed-slider form-control-range" type="range" min="500" max="4000" step="1750">
        <div class="ticks">
            <span>x.5</span>
            <span>x1</span>
            <span>x2</span>
