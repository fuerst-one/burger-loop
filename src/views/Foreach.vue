        ...
        data() {
            return {
                ...
                animation: [
                    ...
                    [8, 1, 0, '$burgerCount = 0. Ist das kleiner 3?'],
                    [8, 2, 0, 'Wer weiß das schon, sagen wir einfach ja! Also los.'],
                    [9, 0, 0, 'Erste Bestellung, der "Hamburger", wird gebraten.'],
                    [9, 0, 0, 'Wir machen aus dem $order einen $burger'],
                    ...
                    [9, 0, 0, 'Zweiter Burger: "Cheeseburger", wird gebraten.'],
                    [10, 0, 0, 'Auch der geht an einen hungrigen Kunden.'],
                    [11, 0, 0, 'Und weiter.'],
                    [8, 1, 0, 'Noch Bestellungen da?'],
                    [8, 2, 0, 'Ja. Ein "Double-Cheeseburger" ist noch übrig.'],
                    [9, 0, 0, 'Pfannenwender-Action.'],
                    [10, 0, 0, 'Servier-Action.'],
                    [11, 0, 0, 'Bam.'],
